...
Após a realização da sondagem mecanizada, constatou-se que o manto de intemperismo (regolito) na área de estudo apresenta uma espessura mínima de 5 m. Vide \cref{tab:sondspec} e laudos no \aref{chap:sondspec}.

\subsubsection*{Contato com a rocha}

Não houve contato com rocha até a profundidade de 5 m.
Vide \cref{tab:sondspec} e
laudos no \aref{chap:sondspec}.
